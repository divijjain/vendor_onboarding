defmodule VendorOnboarding.Agent.Checks do
  @moduledoc """
  ...
  alias VendorOnboarding.Agent.McpClient
  ...
  def entity_match(contract_name, w9_name) do
    case Application.get_env(:vendor_onboarding, :agent_entity_match) do
      nil ->
        content =
  ...
  def draft_explanation(%ValidationResult{} = validation) do
    ...
    case Application.get_env(:vendor_onboarding, :agent_draft_explanation) do
