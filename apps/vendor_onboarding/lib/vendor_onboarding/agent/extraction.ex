defmodule VendorOnboarding.Agent.Extraction do
  @moduledoc """
  ...
  alias VendorOnboarding.Agent.Schemas.{ContractExtraction, W9Extraction}
  ...
  def extract_contract(text) do
    case Application.get_env(:vendor_onboarding, :agent_extract_contract) do
  ...
  def extract_w9(text) do
    case Application.get_env(:vendor_onboarding, :agent_extract_w9) do
