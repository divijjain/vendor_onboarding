defmodule VendorOnboarding.Agent.Evals.Run do
  @moduledoc """
  ...
  alias VendorOnboarding.Agent.Evals.{Deterministic, Fixtures, Judge}
  alias VendorOnboarding.Agent.OnboardingReactor
  ...
  defp to_result({:halted, reactor}, fixture) do
    ...
    %Result{
      ...
      findings: validation && VendorOnboarding.Agent.Checks.describe_findings(validation)
    }
  end
