defmodule DocumentComplianceEngine.DocumentJobs.Actions.IngestWebhook do
  ...
  an incoming vendor webhook payload. Called only via `DocumentComplianceEngine.DocumentJobs.ingest_webhook/1`.
  """
  ...
  @spec call(binary()) ::
          {:ok, DocumentComplianceEngine.DocumentJobs.Schema.DocumentJob.t()}
