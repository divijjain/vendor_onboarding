...
#
#     PHX_SERVER=true bin/vendor_onboarding start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :vendor_onboarding, VendorOnboardingWeb.Endpoint, server: true
end
  ...
  config :vendor_onboarding, VendorOnboardingWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/vendor_onboarding_web/router\.ex$"E,
        ~r"lib/vendor_onboarding_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :vendor_onboarding, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :vendor_onboarding, :webhook_secret, webhook_secret
  ...
  #
  #     config :vendor_onboarding, VendorOnboarding.Mailer,
