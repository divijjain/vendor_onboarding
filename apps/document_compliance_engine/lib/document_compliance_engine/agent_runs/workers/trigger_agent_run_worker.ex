defmodule DocumentComplianceEngine.AgentRuns.Workers.TriggerAgentRunWorker do
  ...
  def perform(%Oban.Job{args: %{"document_job_id" => document_job_id}}) do
    case DocumentComplianceEngine.AgentRuns.trigger_agent_run(document_job_id) do
      {:ok, _agent_run} -> :ok
