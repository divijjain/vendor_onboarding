defmodule VendorOnboarding.Agent.Evals.RunTest do
  @moduledoc """
  ...
  alias VendorOnboarding.Agent.Evals.Run
  ...
  test "a raising extractor is recorded as graceful degradation, not a crash" do
    ...
    [result] = Run.run_all([hd(VendorOnboarding.Agent.Evals.Fixtures.all())])
